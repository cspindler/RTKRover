...
- GGA uplink `713D0007` (notify, fix-quality sentences, 1 Hz)
- 15 ms connection interval requested and granted (min = max)
- The image embeds only the BLE name; caster credentials move to the app
- Telemetry: heartbeat keys 12/13/18 and type 3 retired, keys 20/21 added, five
  error codes retired, `rtcm_fifo_overflow` added
